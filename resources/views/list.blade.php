    ...
    <div class = "list row">
        <a class = "element col-md-4 col-sm-6 col-xs-6" href = "/as3100">
            <div class = "card" style = "width: 18rem">
                <img src = "{{ asset('AS3100.jpg') }}" class = "card-img-top" alt = "AS-3100"/>
                <div class = "card-body">
        ...
        <a class = "element col-md-4 col-sm-6 col-xs-6" href = "/as10000">
            <div class = "card" style = "width: 18rem">
                <img src = "{{ asset('AS10000.jpg') }}" class = "card-img-top" alt = "AS-10.000"/>
                <div class = "card-body">
        ...
        <a class = "element col-md-4 col-sm-6 col-xs-6" href = "/as2022">
            <div class = "card" style = "width: 18rem">
                <img src = "{{ asset('AS2022.jpg') }}" class = "card-img-top" alt = "AS2022"/>
                <div class = "card-body">
