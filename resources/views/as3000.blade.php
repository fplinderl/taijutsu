@extends('layout')
@section('content')
    <h1 class = "list-title">AS-3000</h1>
    <div class = "row ">
            ...
            <div id = "carouselExampleIndicators" class = "carousel slide" data-bs-ride = "true">
                <div class = "carousel-indicators">
                    <button type = "button" data-bs-target = "#carouselExampleIndicators" data-bs-slide-to = "0"
                        ...
                        <img src = "{{ asset('as3000-img/1.jpg') }}" class = "d-block w-100"
                             alt = "Ghế massage thông minh: AS-3100">
                    </button>
                    <button type = "button" data-bs-target = "#carouselExampleIndicators" data-bs-slide-to = "1"
                            aria-label = "Slide 2">
                        <img src = "{{ asset('as3000-img/2.jpg') }}" class = "d-block w-100"
                             alt = "Ghế massage thông minh: AS-3100">
                    </button>
                    <button type = "button" data-bs-target = "#carouselExampleIndicators" data-bs-slide-to = "2"
                            aria-label = "Slide 3">
                        <img src = "{{ asset('as3000-img/AS3000.jpg') }}" class = "d-block w-100"
                             alt = "Ghế massage thông minh: AS-3100">
                    </button>
                </div>
        ...
        <div class = "col-lg-6">
            <table class = "table table-striped table-bordered table-bordered table-hover table-responsive ">
                <tr class = "hidden">
                    <td colspan = "2">
                        <h2 class = "tensanpham ">Taijutsu AS - 3000</h2>
    ...
    <div class = "row">
        <img alt = "" src = "{{ asset('as3000-img/3.jpg') }}" alt = "Ghế massage thông minh: AS-3100"/><br/>
        <img alt = "" src = "{{ asset('as3000-img/t5.jpeg') }}" alt = "Ghế massage thông minh: AS-3100"/>
    </div>
@endsection
